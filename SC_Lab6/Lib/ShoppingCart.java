...
public class ShoppingCart {
     ...
     * @throws ProductNotFoundException if not found item in catalog
     */
    ...
    public void removeItem(String productId) throws InvalidOperationException {
        ...
        if (itemToRemove != null) {
            ...
            checkRep();
        } else throw new InvalidOperationException("Cannot remove item. Product ID '" + productId + "' not found in cart.");
